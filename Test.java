class Test
{
   ...
   public static void testHeap()
	 {
		// Cree une file de priorite contenant les entiers de 0 à 9, tous avec priorite +infini
		Heap h = new Heap(10);
		h.decreaseKey(3,1664);
		h.decreaseKey(4,5);
		h.decreaseKey(3,8);
		h.decreaseKey(2,3);
		// A ce moment, la priorite des differents elements est:
		// 2 -> 3
		// 3 -> 8
		// 4 -> 5
		...
		x=  h.pop();
		System.out.println("On a enlevé "+x+" de la file, dont la priorité était " + h.priority(x));
		// La file contient maintenant uniquement les elements 0,1,5,6,7,8,9 avec priorité +infini
	 }
